...
* **[3-cp.c](./3-cp.c)** - Write a program that copies the content of a file to another file.
    ...
    * if the number of argument is not the correct one, exit with code 1971 and print `Usage: cp file_from file_to`, followed by a new line, on the `POSIX` standard error
